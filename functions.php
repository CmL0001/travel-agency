...
function my_responsive_thumbnail($post_id) {
    ...
    $thumb_medium = wp_get_attachment_image_src($attachment_id, 'feauturedTour');
    ...
    echo '<!--[if IE 9]></video><![endif]-->'; // fallback for IE 9
...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('fancybox', get_template_directory_uri() . '/js/jquery.fancybox.min.js', array(), '3.5.7'); // FancyBox
        ...
        wp_enqueue_script('picturefill'); // Enqueue it!
         ...
         wp_register_script('slickNav', get_template_directory_uri() . '/js/jquery.slicknav.min.js', array(), '1.0.4'); // SlickNav
...
function html5blank_styles()
{
    ...
    wp_register_style('fancyboxcss', get_template_directory_uri() . '/css/jquery.fancybox.min.css', array(), '1.0', 'all');
    wp_enqueue_style('fancyboxcss'); // Enqueue it!

    wp_register_style('pontanoFont', 'https://fonts.googleapis.com/css2?family=Pontano+Sans', array(), '1.0', 'all');
    wp_enqueue_style('pontanoFont');

    wp_register_style('LatoFont', 'https://fonts.googleapis.com/css2?family=Lato:wght@700&display=swap', array(), '1.0', 'all');
    wp_enqueue_style('LatoFont');

    wp_register_style('slickNavCSS', get_template_directory_uri() . '/css/slicknav.min.css', array(), '1.0.4', 'all');
